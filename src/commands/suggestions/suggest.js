...
module.exports = {
  ...
  cooldown: 15,
  botPerms: ["EMBED_LINKS", "USE_EXTERNAL_EMOJIS", "MANAGE_WEBHOOKS", "ADD_REACTIONS"],
  async execute(client, message, args) {
    ...
    if (!sb) {
      return message.reply(
        "Ups! This servver doesn't have the suggestions enabled. Use `enable channel suggestions @channel` to enable them"
      );
    }
