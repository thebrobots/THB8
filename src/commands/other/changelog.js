...
module.exports = {
  ...
  async execute(client, message, args) {
    let newEmbed = new Discord.MessageEmbed()
      ...
      .addField(
        "Enable and disable",
        "We added `enable` and `disable` commands so you can now choose what happens in your server. You can enable or disable suggestions, levelup and commands. (also logs but the bot will not do anything bc We didn't finish them ,:)"
      )
